...
local ToggleUseDisplayNameForTeleport = TeleportToPlayer:addToggle("Use Display Name",useDisplayName,function(newValue)
	useDisplayName = newValue
end)
...
do
	...
	local audioId = Audio:addTextbox("Audio ID","Enter Audio ID here")
	...
	HB:Connect(function()
		...
		if os.clock() - lastChange >= 0.8 then
